    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-1 space-y-3 order-2 lg:order-1">
          <Card className="bg-[#0e1319]/80 border-white/10 shadow-lg backdrop-blur">
            ...
            <CardContent className="space-y-2 text-xs px-3.5 pb-3.5">
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/[0.02] border border-white/5">
                <span className="flex items-center gap-1.5 text-neutral-300">
                  <IconBook className="h-3.5 w-3.5 text-emerald-400" />
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/[0.02] border border-white/5">
                <span className="flex items-center gap-1.5 text-neutral-300">
                  <IconBuildingFactory2 className="h-3.5 w-3.5 text-cyan-400" />
                  Registered Coal Mines
                </span>
                <span className="font-mono font-bold text-cyan-400">30 Mines</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/[0.02] border border-white/5">
                <span className="flex items-center gap-1.5 text-neutral-300">
          ...
          <div className="hidden lg:block rounded-xl border border-amber-500/20 bg-amber-500/5 p-3 text-[11px] text-amber-200/90 leading-relaxed">
